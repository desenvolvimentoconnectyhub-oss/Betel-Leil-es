...
const icons: Record<string, typeof Database> = {
  ...
  meta_ads: BarChart3,
  meta_social: MessageSquare,
  google_ads: BadgeDollarSign,
  google_analytics: MonitorDot,
...
const integrationDescriptions: Record<string, string> = {
  ...
  meta_whatsapp: "WhatsApp Cloud API oficial da Meta para campanhas, templates, listas com opt-in e webhooks.",
  meta_ads: "Conta de anuncios da Meta para campanhas, criativos, pixel, CAPI e recomendacoes IA.",
  meta_social: "Facebook Page e Instagram Business para organico, inbox, comentarios e Messenger.",
  google_ads: "Google Ads para campanhas, keywords, conversoes, custos e recomendacoes IA.",
  google_analytics: "GA4 para eventos, funis, origem de leads, UTMs e conversoes.",
  google_search_console: "Search Console para SEO, consultas, paginas e trafego organico.",
  google_business_profile: "Perfil da empresa no Google para reputacao, posts, buscas locais e mensagens.",
  google_maps: "Google Maps Platform para validar endereco, coordenadas e sinais de liquidez local.",
