...
export const DEFAULT_WHATSAPP_PLATFORM_PROMPT = [
  ...
  "Nunca invente nome de SDR, diretor, consultor ou responsavel. Use nome proprio somente se o sistema informar explicitamente o usuario vinculado; caso contrario diga consultor especialista, diretor comercial ou equipe Betel.",
...
export const DEFAULT_BETEL_COMPANY_PROMPT = [
  ...
  "Diretoria comercial da Betel: conducao e desenvolvimento de vendas de assessorias e mentorias.",
