...
const defaultTemplates: MessageTemplate[] = [
  ...
  },
  {
    ...
    channel: "whatsapp",
    audienceKey: "admin",
    name: "Senha administrativa cadastrada",
    description: "Mensagem enviada depois que o usuario administrativo define a senha.",
    subjectTemplate: "Oi, {{recipient_first_name}}. Seu acesso ao painel Betel esta pronto.",
    bodyTemplate: [
      "Sua senha foi cadastrada com sucesso.",
      "",
      "Use seu email {{recipient_email}} e a senha que voce acabou de criar para entrar no painel.",
      "",
      "Toque no botao abaixo para acessar.",
    ].join("\n"),
    guardrailTemplate: "Link interno e pessoal. Nunca compartilhe sua senha.",
    buttonLabelTemplate: "Abrir painel",
    buttonUrlTemplate: "{{panel_url}}",
    variables: ["recipient_first_name", "recipient_email", "panel_url"],
    status: "active",
    version: 1,
  },
  {
    ...
    channel: "whatsapp",
    audienceKey: "admin",
    name: "Lote pronto para revisao interna",
    description: "Aviso ao setor quando um lote de imoveis termina a analise automatica.",
    subjectTemplate: "Betel AI - {{ready_count}} imovel(is) aguardam {{stage_name}}",
    bodyTemplate: [
      "Oi, {{recipient_first_name}}.",
      "",
      "O lote {{batch_label}} terminou a analise automatica.",
      "{{ready_count}} imovel(is) estao prontos para conferencia no setor {{sector_name}}.",
      "",
      "Acesse o painel para revisar e aprovar os imoveis liberados.",
    ].join("\n"),
    guardrailTemplate: "Aviso interno automatico. Revise no painel antes de encaminhar a proxima etapa.",
    buttonLabelTemplate: "Abrir fila",
    buttonUrlTemplate: "{{action_url}}",
    variables: ["recipient_first_name", "ready_count", "stage_name", "batch_label", "sector_name", "action_url"],
    status: "active",
    version: 1,
  },
  {
    ...
    channel: "whatsapp",
    audienceKey: "admin",
    name: "Nova tarefa interna de workflow",
    description: "Aviso ao setor quando uma oportunidade entra em uma nova etapa.",
    subjectTemplate: "Betel AI - nova tarefa: {{stage_name}}",
    bodyTemplate: [
      "Oi, {{recipient_first_name}}.",
      "",
      "{{task_title}}",
    ...
    guardrailTemplate: "Aviso interno automatico. A decisao deve ser registrada no painel.",
    buttonLabelTemplate: "Abrir tarefa",
    buttonUrlTemplate: "{{action_url}}",
    variables: ["recipient_first_name", "stage_name", "task_title", "task_description", "action_url"],
    status: "active",
    version: 1,
  },
  {
