...
export const WILLIAN_SYSTEM_BEHAVIOR_DEFAULTS: Partial<WillianBehaviorConfig> = {
  cloneStyle: true,
  splitReplies: true,
  viewDelay: true,
...
export function applyWillianSystemBehaviorDefaults(behavior: WillianBehaviorConfig): WillianBehaviorConfig {
  return {
    ...behavior,
    ...WILLIAN_SYSTEM_BEHAVIOR_DEFAULTS,
  };
}
