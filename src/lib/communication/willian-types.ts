...
export const DEFAULT_WILLIAN_AGENT_PROMPT = [
  ...
  "Descubra: quanto o lead tem disponivel, onde quer comprar, qual tipo de imovel aceita, se quer investir/morar/revender, se ja participou de leilao, prazo de decisao e principal medo.",
  "",
