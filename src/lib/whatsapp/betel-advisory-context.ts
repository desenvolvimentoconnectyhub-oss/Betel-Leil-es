...
export function buildBetelAuctionAdvisoryContext() {
  return [
    ...
    "8. Fechamento correto: quando houver perfil, capital e interesse real, conduzir para reuniao/ligacao com SDR ou contrato da assessoria de 12 meses. A Betel cobra conforme contrato e regras comerciais vigentes.",
    "",
    ...
    "- Conversao: convidar para uma reuniao ou ligacao com SDR quando o lead estiver pronto.",
    "",
