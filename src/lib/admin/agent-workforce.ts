  ...
  },
  {
    ...
    agents: [
      ...
      },
      {
        ...
        role: "Atende e distribui oportunidades por WhatsApp com opt-in, frequencia, plano e auditoria por usuario.",
        promptName: "multichannel_dispatch",
        promptVersion: "v0.1",
        status: "planned",
        tone: "yellow",
        trigger: "Oportunidade aprovada e usuario possui canal permitido",
        inputs: ["Preferencias do usuario", "Plano", "WhatsApp opt-in", "Resumo aprovado"],
        outputs: ["whatsapp_jobs", "communication_logs"],
        guardrails: ["Respeitar opt-in", "Controlar frequencia", "Registrar atendimento no WhatsApp"],
      },
    ],
  },
  {
...
export const agentWorkflowEdges: AgentWorkflowEdge[] = [
  ...
  },
  {
    ...
    toAgent: "Agente de WhatsApp",
    condition: "Usuario possui opt-in de WhatsApp.",
    trigger: "Preparar atendimento por WhatsApp com frequencia e contexto.",
    output: "Fila de WhatsApp com logs de entrega por usuario.",
    requiresHumanApproval: true,
    tone: "yellow",
  },
  {
...
export const communicationSegments: CommunicationSegment[] = [
  ...
  {
    label: "WhatsApp",
    agent: "Agente de WhatsApp",
    audience: "Usuarios com opt-in de WhatsApp",
    rule: "Respeita opt-in, plano, frequencia e logs de atendimento.",
    status: "Futuro",
    tone: "yellow",
  },
];
...
export const agentOfficeRooms: AgentOfficeRoom[] = [
  ...
  },
  {
    ...
    status: "Planejado",
    tone: "green",
    agents: ["Camila — Atendimento Premium", "Tiago — Captacao de Leads", "Beatriz — Gestora de Comunidade", "Agente de WhatsApp"],
