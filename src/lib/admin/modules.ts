...
export const adminModules: AdminModule[] = [
  ...
  createAdminModule({
    ...
    description:
      "Central futura para campanhas pagas da Meta com IA, criativos, conjuntos, eventos, custos e recomendacoes.",
    icon: "BarChart3",
    accent: "yellow",
    status: "build",
    statusLabel: "Planejado",
  ...
  createAdminModule({
    ...
    description:
      "Inbox futuro para conversas originadas pela WhatsApp Cloud API oficial, separado do atendimento ConnectyHub.",
    icon: "MessageCircle",
    accent: "cyan",
    status: "build",
    statusLabel: "Planejado",
  ...
  createAdminModule({
    ...
    description: "Modulo futuro para campanhas Google Ads, keywords, conversoes e otimizacao com IA.",
  ...
  createAdminModule({
    ...
    description: "Modulo futuro para GA4, eventos, funis, fontes e comportamento de visitantes.",
    icon: "MonitorDot",
    accent: "cyan",
    status: "build",
    statusLabel: "Planejado",
  ...
  createAdminModule({
    ...
    description: "Central futura para SEO, conteudo organico, distribuicao e performance por canal.",
    icon: "RadioTower",
    accent: "green",
    status: "build",
    statusLabel: "Planejado",
  ...
  createAdminModule({
    ...
    description: "Modulo futuro para centralizar mensagens e eventos de paginas, Instagram, Messenger e WhatsApp oficial.",
    icon: "Database",
    accent: "purple",
    status: "build",
    statusLabel: "Planejado",
  ...
  createAdminModule({
    ...
    description: "Biblioteca futura de criativos, variacoes, copies, thumbnails e testes por campanha.",
    icon: "Puzzle",
    accent: "yellow",
    status: "build",
    statusLabel: "Planejado",
